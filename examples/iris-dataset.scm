;;;; iris-dataset.scm
;;;; 
;;;; Iris dataset in columnar format for use with gg-plot
;;;;
;;;; Dataset format expected by gg-plot:
;;;;   ((column-name1 . (value1 value2 value3 ...))
;;;;    (column-name2 . (value1 value2 value3 ...))
;;;;    ...)
